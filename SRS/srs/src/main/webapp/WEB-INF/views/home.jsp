      ...
      <div class="collapse navbar-collapse navHeader" id="myNavbar">
        <div class="header">
          <ul class="nav nav-tabs">
            <li class="active">
              <a href="/"><h4 class="title">자율좌석예약시스템</h4></a>
            </li>
            <li>
              <a href="/room-status"><h4 class="title">회의실 예약현황</h4></a>
            </li>
          </ul>

          <div class="date">
            <div class="curDate">
              <span class="cdate">02월 05일</span>
              <span class="cday">화요일</span>
            </div>
        ...
        <div class="col-sm-3 sidenav partList">
          <div class="partListWrap">
            <div class="dropdown selectTeam">
              <button
                class="btn btn-default dropdown-toggle btn-lg dropdownBtn"
                type="button"
                data-toggle="dropdown"
              >
                <span class="defaultOption">-- 팀을 선택하세요 --</span>
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body modalBody">
                ...
                <div class="userInfo">
                  <div class="seatNum">좌석 번호 : <span></span></div>
                  <div class="team"></div>
