...
class Streamer:
    ...
    def bytescode(self):
        ...
        if not self.capture.isOpened():
            ...
            cv2.putText(frame, "locate your face in CAMERA", (10, 30), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (255, 51, 51),
                        2)
            ...
            if self.detect:
                ...
                if len(self.recFace) >= 1:
                    cv2.imwrite('C:/ensglobal_srs/facerecognition/tempface/recImg.jpg', np.array(self.recImg))
                    cv2.imwrite('C:/ensglobal_srs/facerecognition/tempface/recFace.jpg', np.array(self.recFace))
    ...
    def face_detector(self, img, size=0.5):
        ...
        if faces is ():
            print('얼굴 검출 안됨')
            cv2.putText(img, "locate your face in CAMERA", (10, 30), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (255, 51, 51),
                        2)
            # cv2.circle(img, (180, 160), 100, (102, 205, 51), 2)
